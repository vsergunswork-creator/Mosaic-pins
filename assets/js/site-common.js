(() => {
  ...
  const TEXT = {
    de: {
      ...
      "Leave a review — it will appear after approval.":"Hinterlasse eine Bewertung – sie erscheint nach der Freigabe.",
      ...
      "Approved reviews":"Freigegebene Bewertungen",
      "Your name":"Dein Name",
    ...
    ru: {
      ...
      "Leave a review — it will appear after approval.":"Оставьте отзыв — он появится после одобрения.",
    ...
    fr: {
      ...
      "Leave a review — it will appear after approval.":"Laissez un avis — il apparaîtra après validation.",
      ...
      "Approved reviews":"Avis approuvés",
      "Your name":"Votre nom",
