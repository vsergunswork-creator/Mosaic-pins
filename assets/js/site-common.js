(() => {
  ...
  const TEXT = {
    de: {
      ...
      "We ship mosaic pins worldwide. Below is a simple overview of processing time, delivery and tracking.":"Wir versenden Mosaik-Pins weltweit. Nachfolgend findest du einen einfachen Überblick über Bearbeitungszeit, Lieferung und Sendungsverfolgung.",
      "Processing time":"Bearbeitungszeit","Orders are typically processed within":"Bestellungen werden in der Regel innerhalb von","1–3 business days":"1–3 Werktagen","During peak periods it may take a little longer.":"In Zeiten hoher Nachfrage kann es etwas länger dauern.","Handcrafted & carefully packed":"Handgefertigt & sorgfältig verpackt",
      "Shipping & tracking":"Versand & Sendungsverfolgung","All shipments include a":"Alle Sendungen enthalten eine","tracking number":"Sendungsnummer","Packages are sent as tracked parcels (up to":"Pakete werden als Sendungen mit Sendungsverfolgung verschickt (bis","2 kg":"2 kg","Tracking updates may appear with a delay.":"Aktualisierungen der Sendungsverfolgung können verzögert erscheinen.","Delivery time depends on destination and carrier.":"Die Lieferzeit hängt vom Zielort und Versanddienstleister ab.",
      "Live DHL shipping rates":"Aktuelle DHL-Versandtarife","Shipping is calculated automatically in your cart using the current DHL rate for your destination.":"Die Versandkosten werden im Warenkorb automatisch anhand des aktuellen DHL-Tarifs für dein Zielland berechnet.","We use a":"Wir verwenden ein","tracked DHL Paket up to 2 kg":"DHL Paket mit Sendungsverfolgung bis 2 kg","whenever that service is available.":"sofern dieser Service verfügbar ist.","Select your shipping country in the cart.":"Wähle dein Versandland im Warenkorb aus.","The current tracked DHL price appears before payment.":"Der aktuelle DHL-Preis mit Sendungsverfolgung wird vor der Zahlung angezeigt.","The same destination and rate are verified again on the server during checkout.":"Zielland und Tarif werden beim Checkout auf dem Server erneut überprüft.","No fixed country zones • live destination pricing":"Keine festen Länderzonen • aktuelle Preise nach Zielland",
      "Delivery estimates":"Voraussichtliche Lieferzeiten","Delivery time depends on the destination, customs processing and the local delivery network.":"Die Lieferzeit hängt vom Zielland, der Zollabfertigung und dem lokalen Zustellnetz ab.","Your tracking number will be emailed after dispatch.":"Deine Sendungsnummer wird dir nach dem Versand per E-Mail zugesandt.","Delivery estimates are not guarantees.":"Die angegebenen Lieferzeiten sind unverbindliche Schätzungen.",
      "Customs & import taxes":"Zoll & Einfuhrabgaben","International orders may be subject to customs fees, VAT or import taxes.":"Bei internationalen Bestellungen können Zollgebühren, Mehrwertsteuer oder Einfuhrabgaben anfallen.","These charges are the buyer’s responsibility.":"Diese Gebühren trägt der Käufer.","Need help with shipping?":"Brauchst du Hilfe beim Versand?","Contact:":"Kontakt:","← Back to Shop":"← Zurück zum Shop",
    ...
    ru: {
      ...
      "We ship mosaic pins worldwide. Below is a simple overview of processing time, delivery and tracking.":"Мы отправляем мозаичные пины по всему миру. Ниже — краткая информация об обработке заказа, доставке и отслеживании.",
      "Processing time":"Время обработки","Orders are typically processed within":"Обычно заказы обрабатываются в течение","1–3 business days":"1–3 рабочих дней","During peak periods it may take a little longer.":"В периоды высокой загрузки обработка может занять немного больше времени.","Handcrafted & carefully packed":"Ручная работа • бережная упаковка",
      "Shipping & tracking":"Доставка и отслеживание","All shipments include a":"Все отправления имеют","tracking number":"трек-номер","Packages are sent as tracked parcels (up to":"Посылки отправляются с отслеживанием (до","2 kg":"2 кг","Tracking updates may appear with a delay.":"Информация об отслеживании может обновляться с задержкой.","Delivery time depends on destination and carrier.":"Срок доставки зависит от страны назначения и перевозчика.",
      "Live DHL shipping rates":"Актуальные тарифы DHL","Shipping is calculated automatically in your cart using the current DHL rate for your destination.":"Стоимость доставки автоматически рассчитывается в корзине по актуальному тарифу DHL для выбранной страны.","We use a":"Мы используем","tracked DHL Paket up to 2 kg":"DHL Paket с отслеживанием до 2 кг","whenever that service is available.":"если эта услуга доступна для выбранного направления.","Select your shipping country in the cart.":"Выберите страну доставки в корзине.","The current tracked DHL price appears before payment.":"Актуальная стоимость доставки DHL с отслеживанием отображается до оплаты.","The same destination and rate are verified again on the server during checkout.":"Страна назначения и тариф повторно проверяются сервером во время оформления заказа.","No fixed country zones • live destination pricing":"Без фиксированных зон • актуальная цена для страны назначения",
      "Delivery estimates":"Ориентировочные сроки доставки","Delivery time depends on the destination, customs processing and the local delivery network.":"Срок доставки зависит от страны назначения, таможенного оформления и местной службы доставки.","Your tracking number will be emailed after dispatch.":"После отправки трек-номер будет отправлен вам по электронной почте.","Delivery estimates are not guarantees.":"Указанные сроки доставки являются ориентировочными и не гарантируются.",
      "Customs & import taxes":"Таможенные и импортные сборы","International orders may be subject to customs fees, VAT or import taxes.":"Международные заказы могут облагаться таможенными сборами, НДС или импортными налогами.","These charges are the buyer’s responsibility.":"Эти расходы оплачивает покупатель.","Need help with shipping?":"Нужна помощь с доставкой?","Contact:":"Контакт:","← Back to Shop":"← Назад в магазин",
    ...
    fr: {
      ...
      "We ship mosaic pins worldwide. Below is a simple overview of processing time, delivery and tracking.":"Nous expédions nos pins mosaïque dans le monde entier. Voici un aperçu simple des délais de traitement, de la livraison et du suivi.",
      "Processing time":"Délai de traitement","Orders are typically processed within":"Les commandes sont généralement traitées sous","1–3 business days":"1 à 3 jours ouvrés","During peak periods it may take a little longer.":"En période de forte activité, le traitement peut prendre un peu plus de temps.","Handcrafted & carefully packed":"Fabriqué à la main & emballé avec soin",
      "Shipping & tracking":"Livraison & suivi","All shipments include a":"Tous les envois comprennent un","tracking number":"numéro de suivi","Packages are sent as tracked parcels (up to":"Les colis sont expédiés avec suivi (jusqu’à","2 kg":"2 kg","Tracking updates may appear with a delay.":"Les informations de suivi peuvent apparaître avec un léger délai.","Delivery time depends on destination and carrier.":"Le délai de livraison dépend de la destination et du transporteur.",
      "Live DHL shipping rates":"Tarifs DHL en temps réel","Shipping is calculated automatically in your cart using the current DHL rate for your destination.":"Les frais de livraison sont calculés automatiquement dans votre panier selon le tarif DHL actuel pour votre destination.","We use a":"Nous utilisons un","tracked DHL Paket up to 2 kg":"DHL Paket suivi jusqu’à 2 kg","whenever that service is available.":"lorsque ce service est disponible.","Select your shipping country in the cart.":"Sélectionnez votre pays de livraison dans le panier.","The current tracked DHL price appears before payment.":"Le tarif DHL suivi actuel s’affiche avant le paiement.","The same destination and rate are verified again on the server during checkout.":"La destination et le tarif sont vérifiés à nouveau sur le serveur lors du paiement.","No fixed country zones • live destination pricing":"Pas de zones fixes • tarif actuel selon la destination",
      "Delivery estimates":"Délais de livraison estimés","Delivery time depends on the destination, customs processing and the local delivery network.":"Le délai de livraison dépend de la destination, du traitement douanier et du réseau de livraison local.","Your tracking number will be emailed after dispatch.":"Votre numéro de suivi vous sera envoyé par e-mail après l’expédition.","Delivery estimates are not guarantees.":"Les délais indiqués sont des estimations et ne sont pas garantis.",
      "Customs & import taxes":"Douane & taxes d’importation","International orders may be subject to customs fees, VAT or import taxes.":"Les commandes internationales peuvent être soumises à des frais de douane, à la TVA ou à des taxes d’importation.","These charges are the buyer’s responsibility.":"Ces frais sont à la charge de l’acheteur.","Need help with shipping?":"Besoin d’aide pour la livraison ?","Contact:":"Contact :","← Back to Shop":"← Retour à la boutique",
