(() => {
  ...
  const TEXT = {
    ...
    ru: {
      ...
      "No restocking fee is charged.":"Плата за повторное размещение товара на складе не взимается.",
      ...
      "Ships from Germany. USA delivery: 8–21 business days total estimate (1–3 processing + 7–18 transit).":"Отправка из Германии. США: общий ориентировочный срок 8–21 рабочий день (1–3 обработка + 7–18 перевозка).",
      "30-day returns. Buyer pays return shipping for change-of-mind returns. No restocking fee.":"Возврат в течение 30 дней. Если покупатель передумал, обратную пересылку оплачивает покупатель. Без платы за повторное размещение на складе.",
      "Info":"Информация",
