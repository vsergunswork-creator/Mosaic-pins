(() => {
  ...
  const TEXT = {
    de: {
      ...
      "Unused items in their original condition can be returned within 30 days of receipt. The buyer is responsible for return shipping costs. Damaged, defective or incorrectly shipped items are handled separately.":"Unbenutzte Artikel im Originalzustand können innerhalb von 30 Tagen nach Erhalt zurückgegeben werden. Die Rücksendekosten trägt der Käufer. Beschädigte, fehlerhafte oder falsch gelieferte Artikel werden gesondert behandelt.",
      ...
      "Returns are accepted by mail. For standard returns, the buyer is responsible for return shipping costs. We recommend a tracked return service.":"Rückgaben werden per Post akzeptiert. Bei regulären Rückgaben trägt der Käufer die Rücksendekosten. Wir empfehlen einen Versand mit Sendungsverfolgung.",
      ...
      "Custom or personalized items are not eligible for standard returns unless they arrive damaged, defective or incorrect. Your statutory consumer rights remain unaffected.":"Individuell angefertigte oder personalisierte Artikel sind von regulären Rückgaben ausgeschlossen, außer sie kommen beschädigt, fehlerhaft oder falsch an. Deine gesetzlichen Verbraucherrechte bleiben unberührt.",
      "This exception applies only to items made to order or personalized specifically for the buyer. All standard products in our catalog are covered by our regular 30-day return policy.":"Diese Ausnahme gilt nur für Artikel, die auf Bestellung angefertigt oder speziell für den Käufer personalisiert wurden. Alle Standardprodukte in unserem Katalog fallen unter unsere reguläre 30-Tage-Rückgaberegelung.",
      ...
      "30-day returns for unused items in original condition. Buyer pays return shipping. No restocking fee.":"30 Tage Rückgabe für unbenutzte Artikel im Originalzustand. Der Käufer trägt die Rücksendekosten. Keine Wiedereinlagerungsgebühr.",
      "Info":"Info",
    ...
    ru: {
      ...
      "Unused items in their original condition can be returned within 30 days of receipt. The buyer is responsible for return shipping costs. Damaged, defective or incorrectly shipped items are handled separately.":"Неиспользованные товары в первоначальном состоянии могут быть возвращены в течение 30 дней с момента получения. Покупатель оплачивает обратную пересылку. Повреждённые, дефектные или ошибочно отправленные товары обрабатываются отдельно.",
      ...
      "Returns are accepted by mail. For standard returns, the buyer is responsible for return shipping costs. We recommend a tracked return service.":"Возврат принимается по почте. При обычном возврате расходы на обратную пересылку оплачивает покупатель. Рекомендуем отправку с отслеживанием.",
      ...
      "Custom or personalized items are not eligible for standard returns unless they arrive damaged, defective or incorrect. Your statutory consumer rights remain unaffected.":"Индивидуальные или персонализированные товары не подлежат обычному возврату, кроме случаев, когда товар пришёл повреждённым, дефектным или был отправлен ошибочно. Законные права потребителя сохраняются.",
      "This exception applies only to items made to order or personalized specifically for the buyer. All standard products in our catalog are covered by our regular 30-day return policy.":"Это исключение относится только к товарам, изготовленным на заказ или персонализированным специально для покупателя. Все стандартные товары из нашего каталога подпадают под обычную 30-дневную политику возврата.",
      ...
      "30-day returns for unused items in original condition. Buyer pays return shipping. No restocking fee.":"Возврат в течение 30 дней для неиспользованных товаров в первоначальном состоянии. Обратную пересылку оплачивает покупатель. Без комиссии за возврат.",
      "Info":"Информация",
    ...
    fr: {
      ...
      "Unused items in their original condition can be returned within 30 days of receipt. The buyer is responsible for return shipping costs. Damaged, defective or incorrectly shipped items are handled separately.":"Les articles non utilisés et dans leur état d’origine peuvent être retournés dans les 30 jours suivant leur réception. Les frais de retour sont à la charge de l’acheteur. Les articles endommagés, défectueux ou envoyés par erreur sont traités séparément.",
      ...
      "Returns are accepted by mail. For standard returns, the buyer is responsible for return shipping costs. We recommend a tracked return service.":"Les retours sont acceptés par voie postale. Pour les retours standards, les frais de retour sont à la charge de l’acheteur. Nous recommandons un envoi de retour avec suivi.",
      ...
      "Custom or personalized items are not eligible for standard returns unless they arrive damaged, defective or incorrect. Your statutory consumer rights remain unaffected.":"Les articles personnalisés ou fabriqués sur mesure ne sont pas éligibles aux retours standards, sauf s’ils arrivent endommagés, défectueux ou incorrects. Vos droits légaux de consommateur restent inchangés.",
      "This exception applies only to items made to order or personalized specifically for the buyer. All standard products in our catalog are covered by our regular 30-day return policy.":"Cette exception s’applique uniquement aux articles fabriqués sur commande ou personnalisés spécialement pour l’acheteur. Tous les produits standard de notre catalogue sont couverts par notre politique de retour habituelle de 30 jours.",
      ...
      "30-day returns for unused items in original condition. Buyer pays return shipping. No restocking fee.":"Retours sous 30 jours pour les articles non utilisés et dans leur état d’origine. Les frais de retour sont à la charge de l’acheteur. Aucun frais de remise en stock.",
      "Info":"Infos",
  ...
  function buildLanguageControl(){
    ...
    language.addEventListener("change", () => {
      ...
      try {
        document.cookie = `${LANG_KEY}=${encodeURIComponent(language.value)}; Path=/; Max-Age=31536000; SameSite=Lax`;
      } catch (_) {}
      location.reload();
    });
    return language;
